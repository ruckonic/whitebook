...
exports.getorderpage=((req,res,next)=>{
    res.render('contact',{verifuser:req.session.userId,orderdescription:orderdescription,orderimg:orderimg})
})


exports.order=((req,res,next)=>{
    req.body.ordered=('a'!='a')
    ordermodel.addorder(req.body.firstname,req.body.lastname,req.body.phonenumber,req.body.street,req.body.city,req.body.zipcode,req.body.booklink,req.body.ordered).then(()=>{
        res.redirect('/home')
    })
})
...
//general info
    const orderdescription='Order your book now by complete this form correctly!!'
